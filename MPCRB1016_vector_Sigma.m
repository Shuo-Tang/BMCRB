...
for k = 1%:3
    ...
    SigmaCandidate = (0.1:0.1:4);
    nCandidate = length(SigmaCandidate);
    ...
    for n = 1:nCandidate
        n
        param_th.Sigma = SigmaCandidate(n)*eye(3);
        parfor m = 1:n_trial
            %% Data Generation
            % Data of Prior
    ...
    semilogy(SigmaCandidate,RMSE1,'LineWidth',1.2,'Marker','*')
    semilogy(SigmaCandidate,sqrt(bound1),'LineWidth',2)
    legend('RMSE of $\hat{\theta}_1 - \psi_1$','Bound of $\theta_1 - \psi_1$',...
        'RMSE of $\hat{\theta}_1 - \psi_1$','Bound of $\theta_1 - \psi_1$',...
        'RMSE of $\hat{\theta}_1 - \psi_1$','Bound of $\theta_1 - \psi_1$',...
